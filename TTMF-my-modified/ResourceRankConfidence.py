...
if __name__ == "__main__":
    ...
    file_data = "/data1/yk/Lab/TTMF_my/dataset"
    #
    ...
    testfile=file_data+"/conf_test2id.txt"
    ...
    trainExamples.append(testExamples)
    trainExamples.append(validExamples)
