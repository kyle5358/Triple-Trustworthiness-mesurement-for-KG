...
def write_dataset(file_path,array):
    ...
    train_file = open("C:\\python_program\\TTMFDataProcess\\FinalDataset\\golddataset\\train2id.txt", 'a', encoding='utf-8')  # 输出文件位置
    ...
    test_file = open("C:\\python_program\\TTMFDataProcess\\FinalDataset\\golddataset\\test2id.txt", 'a', encoding='utf-8')  # 输出文件位置
    ...
    valid_file = open("C:\\python_program\\TTMFDataProcess\\FinalDataset\\golddataset\\valid2id.txt", 'a', encoding='utf-8')  # 输出文件位置
...
filePath="C:\python_program\TTMFDataProcess\dataset\\conf\\"
